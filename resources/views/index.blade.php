        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body" style="background-color: {!! config('app.colorBody') !!};min-height:300px;padding:30px;margin-top:95vh;">
                    <p style="font-size:20px;color:green;background-color:#fff2cc;padding:20px;float:right;width:300px;">Out quality and service will help boost the <u style="color:red;">Energy</u> in your production.</p>
